...
import com.sisindia.ai.android.databinding.DialogFragmentAddedGrievanceBinding;
...
public class AddedGrievanceDialogFragment extends IopsBaseDialogFragment {

    private DialogFragmentAddedGrievanceBinding binding;
    private AddedGrievanceViewModel viewModel;

    public static AddedGrievanceDialogFragment newInstance(int grievanceId) {
        AddedGrievanceDialogFragment dialogFragment = new AddedGrievanceDialogFragment();
    ...
    protected void extractBundle() {
        ...
        if (bundle != null && bundle.containsKey(GrievanceEntity.class.getSimpleName())) {
            ...
            viewModel.onOpenGrievance(grievanceId);
        } else {
    ...
    protected View initViewBinding(LayoutInflater inflater, ViewGroup container) {
        binding = (DialogFragmentAddedGrievanceBinding) bindFragmentView(getLayoutResource(), inflater, container);
    ...
    protected int getLayoutResource() {
        return R.layout.dialog_fragment_added_grievance;
    }
}
