...
import com.sisindia.ai.android.databinding.FragmentAddPoaBinding

/**
 * Created by Ashu Rajput on 4/3/2020.
 */
class AddPoaFragment : IopsBaseFragment() {

    private lateinit var viewModel: AddPoaAndIpViewModel
    private lateinit var binding: FragmentAddPoaBinding

    companion object {
        fun newInstance(): AddPoaFragment = AddPoaFragment()
    }

    override fun getLayoutResource(): Int {
        return R.layout.fragment_add_poa
    }
