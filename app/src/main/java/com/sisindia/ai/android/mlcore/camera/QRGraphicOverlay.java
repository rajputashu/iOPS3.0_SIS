...
public class QRGraphicOverlay extends View {
     ...
     * coordinates later.
     */
    public void setCameraInfo(QRCameraSource cameraSource) {
     ...
     * instances to the overlay using {@link QRGraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        protected final QRGraphicOverlay overlay;
        protected final Context context;

        protected Graphic(QRGraphicOverlay overlay) {
