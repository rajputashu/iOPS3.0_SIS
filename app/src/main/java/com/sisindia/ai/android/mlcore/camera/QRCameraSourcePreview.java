 ...
 */
public class QRCameraSourcePreview extends FrameLayout {

    private final SurfaceView surfaceView;
    private QRGraphicOverlay graphicOverlay;
    private boolean startRequested = false;
    private boolean surfaceAvailable = false;
    private QRCameraSource cameraSource;
    private Size cameraPreviewSize;

    public QRCameraSourcePreview(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void start(QRCameraSource cameraSource) throws IOException {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (cameraPreviewSize != null) {
            if (MlUtils.isPortraitMode(getContext())) {
