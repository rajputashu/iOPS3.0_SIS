...
import static com.sisindia.ai.android.constants.NavigationConstants.OPEN_VULNERABILITY_DASHBOARD;
        ...
        liveData.observe(this, message -> {
            ...
            switch (message.what) {
                ...
                case OPEN_PRE_DASHBOARD_BILL_SUBMISSION_TASK:
                    intent = new Intent(requireActivity(), BillSubmissionCardsActivity.class);
                    break;

                case OPEN_MONINPUT_TASK:
                    intent = new Intent(requireActivity(), MonInputCardsActivity.class);
                    break;

                case OPEN_PRE_DASH_BOARD_BILL_COLLECTION:
                    intent = new Intent(requireActivity(), BillCollectionDetailsOnSites.class);
                    break;

                case OPEN_VULNERABILITY_DASHBOARD:
                    intent = new Intent(requireActivity(), VulnerabilityDashboardActivity.class);
                    break;
            }
